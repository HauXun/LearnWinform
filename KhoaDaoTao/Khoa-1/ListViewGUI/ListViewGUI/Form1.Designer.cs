...
namespace ListViewGUI
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.listViewShow.Size = new System.Drawing.Size(606, 425);
			this.listViewShow.TabIndex = 0;
			this.listViewShow.UseCompatibleStateImageBehavior = false;
			this.listViewShow.SelectedIndexChanged += new System.EventHandler(this.listViewShow_SelectedIndexChanged);
			// 
			// button1
			// 
			...
			this.button2.Text = "Details Icon";
